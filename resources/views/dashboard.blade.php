  ...
  <div class="row gap-5">
    <div class="card text-center" style="width: 18rem;">
     ...
     <div class="card text-center" style="width: 18rem;">
       ...
       <div class="card-body ">
         <h5 class="card-title">Alterar E-mail</h5>
         <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
         <a href="#" class="btn btn-outline-primary">Ir</a>
       </div>
     </div>
     <div class="card text-center" style="width: 18rem;">
       ...
       <div class="card-body">
         <h5 class="card-title">Alterar Telefone</h5>
         <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
         <a href="#" class="btn btn-outline-primary ">Ir</a>
       </div>
     </div>
     ...
     <div class="card text-center" style="width: 18rem;">
       ...
       <div class="card-body">
         <h5 class="card-title">Alterar Endereço</h5>
         <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
         <a href="#" class="btn btn-outline-primary">Ir</a>
       </div>
     </div>
...
<div class="row row2">
<div class="card text-center" style="width: 80rem; height: 24rem;">
   <div class="fa fa-user-circle"></div>
   <div class="card-body">
     <h5 class="card-title">Seja Bem-Vindo !</h5>
     <p class="card-text text">Nesta pagina você pode mudar todas suas informações pessoais.</p>
     <div class="dadosusuario">Usuario: </div>
     <div class="dadosusuario">Email:</div >
     <div class="dadosusuario">Telefone:</div>
     <div class="dadosusuario">CPF:</div>
    <br>
     <a href="#" class="btn btn-outline-primary">Ir</a>
   </div>
 </div>
