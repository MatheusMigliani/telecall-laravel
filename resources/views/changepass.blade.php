                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('user.updatePassword') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email"  disabled name="email" class="form-control" placeholder="Email Cadastrado"required value="{{ auth()->user()->email }}">
                            </div>

                            <div class="form-group">
                                <label for="answer">{{ __('Nome de um Animal Doméstico') }}</label>
                                <input type="text" name="answer" class="form-control" placeholder="Sua pergunta de segurança" required>
                            </div>
                            ...
                            <button type="submit" class="btn btn-success botaoadd botaoredef "> {{ __('Redefinir Senha') }}<i class="fa fa-check-square" aria-hidden="true"></i> </button>
                        </form>
                    </div>
                </div>
            </div>
